...
public class searchSerialNumActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_serial_num);
    ...
    private void requestSearchParamDialog() {
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(searchSerialNumActivity.this);
        View view = layoutInflater.inflate(R.layout.dialog_request_info,null);

        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(searchSerialNumActivity.this);
    ...
    private void goBack(){
        Intent intent = new Intent(this,manageTransactionActivity.class);
